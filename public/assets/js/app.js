$(function () {
    ...
    // Check if MetisMenu is loaded and initialize
    function initMetisMenu() {
        if (typeof $.fn.metisMenu === "function") {
            $("#menu").metisMenu();
        } else {
            // If MetisMenu isn't loaded yet, wait and try again
            console.error("MetisMenu is not loaded.");
        }
    }

    // Start MetisMenu initialization
    initMetisMenu();
