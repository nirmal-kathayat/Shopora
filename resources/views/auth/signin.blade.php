                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form action="{{route('loginProcess')}}" method="post" class="row g-3">
                                            @csrf
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Username</label>
                                                <input type="text" data-validation="required" name="username" class="form-control" id="inputEmailAddress" placeholder="Username">
                                                @error('username')
